...
| Field               | Description                                                                  |
| ------------------- | ---------------------------------------------------------------------------- |
| **Key name**        | Used in bmadconfig.yaml under the module section                                 |
...
| **user_setting**    | If true, stored in config.user.yaml instead of bmadconfig.yaml                   |
...
> Check if `{project-root}/_bmad/bmadconfig.yaml` contains a `{module-code}` section. If not — or if user passed `setup` or `configure` — load `./assets/module-setup.md` and complete registration before proceeding.
