...
description: 'Run BMAD code review with Lens context'
---

# lens-bmad-code-review (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-code-review.prompt.md`
