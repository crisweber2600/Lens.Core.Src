...
description: 'Run BMAD create architecture with Lens context'
---

# lens-bmad-create-architecture (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-create-architecture.prompt.md`
