...
description: 'Run BMAD create epics and stories with Lens context'
---

# lens-bmad-create-epics-and-stories (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-create-epics-and-stories.prompt.md`
