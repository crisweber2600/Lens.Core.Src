...
description: 'Run BMAD create PRD with Lens context'
---

# lens-bmad-create-prd (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-create-prd.prompt.md`
