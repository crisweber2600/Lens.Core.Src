...
description: 'Run BMAD document-project with Lens-aware feature docs scope'
---

# lens-bmad-document-project (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-document-project.prompt.md`
