...
description: 'Run BMAD domain research with Lens context'
---

# lens-bmad-domain-research (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-domain-research.prompt.md`
