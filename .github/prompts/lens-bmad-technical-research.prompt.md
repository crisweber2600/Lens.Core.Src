...
description: 'Run BMAD technical research with Lens context'
---

# lens-bmad-technical-research (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-bmad-technical-research.prompt.md`
