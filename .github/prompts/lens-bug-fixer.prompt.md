...
```bash
uv run --script lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-bug-fixer
```
...
`lens.core/_bmad/lens-work/prompts/lens-bug-fixer.prompt.md`.
