...
```bash
uv run --script lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-bug-reporter
```
...
`lens.core/_bmad/lens-work/prompts/lens-bug-reporter.prompt.md`.
