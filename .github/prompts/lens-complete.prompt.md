...
description: 'Complete feature lifecycle — retrospective, archive, close'
---
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-complete.prompt.md`
