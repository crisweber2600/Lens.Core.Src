...
```bash
uv run --script lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-dev
```
...
`lens.core/_bmad/lens-work/prompts/lens-dev.prompt.md`.
