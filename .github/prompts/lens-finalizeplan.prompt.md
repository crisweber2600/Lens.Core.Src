...
description: 'Run FinalizePlan phase (review, planning bundle, PR handoff)'
---
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-finalizeplan.prompt.md`
