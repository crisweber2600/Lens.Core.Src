...
description: 'Git write operations for Lens features'
---
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-git-orchestration.prompt.md`
