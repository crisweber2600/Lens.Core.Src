...
description: 'Record issues and friction points for active feature'
---

# lens-log-problem (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-log-problem.prompt.md`
