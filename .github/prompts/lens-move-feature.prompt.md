...
description: 'Reclassify feature to different domain/service'
---

# lens-move-feature (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-move-feature.prompt.md`
