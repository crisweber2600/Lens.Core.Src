...
```bash
uv run --script lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-nextlens-bugfix
```
...
`lens.core/_bmad/lens-work/prompts/lens-nextlens-bugfix.prompt.md`.
