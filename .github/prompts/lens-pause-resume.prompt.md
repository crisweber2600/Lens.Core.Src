...
description: 'Pause or resume feature with state preservation'
---

# lens-pause-resume (Stub)
...
3. ONLY AFTER a successful prompt-start sync, read and follow all instructions in: `lens.core/_bmad/lens-work/prompts/lens-pause-resume.prompt.md`
