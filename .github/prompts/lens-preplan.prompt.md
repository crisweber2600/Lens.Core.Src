...
```bash
uv run --script lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-preplan
```
...
`lens.core/_bmad/lens-work/prompts/lens-preplan.prompt.md`.
