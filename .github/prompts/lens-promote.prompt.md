...
description: 'Promote feature through next lifecycle milestone'
---
...
```
Read and follow all instructions in: lens.core/_bmad/lens-work/prompts/lens-promote.prompt.md
```
