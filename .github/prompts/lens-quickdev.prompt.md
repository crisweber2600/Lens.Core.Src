...
```bash
python lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py --caller lens-quickdev
```
...
`lens.core/_bmad/lens-work/prompts/lens-quickdev.prompt.md`.
