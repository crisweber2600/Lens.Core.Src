````prompt
---
description: 'Run LENS Workbench preflight check and activate @lens agent for lifecycle navigation'
---
...
```
Read and follow all instructions in: .github/prompts/lens-work.start.prompt.md
```
