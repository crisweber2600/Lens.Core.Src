...
- **Prompts: Lens Next only** — `.github/prompts/` contains only the published `lens-*.prompt.md` stub family; legacy `lens-work*` prompt aliases are removed during install and blocked from release publication
