...
**Goal:** Prepare the target audience branch and open the promotion PR with the required gate summary.
...
params:
  ...
  Title: "[PROMOTE] ${initiative_root} ${current_audience}->${next_audience} - Adversarial Review Gate"
