...
5. Log `constitution-amended` via state-management skill
6. Request git-orchestration skill commit with governance-prefixed message
...
**For each artifact:**
1. Invoke `constitution.compliance-check` with:
...
*Generated by constitution skill on {today_date}*
```
