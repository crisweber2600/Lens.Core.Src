...
#
# NOTE: state, domain_yaml_files, and service_yaml_files are already
# loaded from Step 0-pre (Batch Context Pre-Load). No additional file
# reads needed.
...
if current_branch == "main":
  ...
  if state != null:
    # Scan pre-loaded initiative configs for one whose branch: field matches current_branch
