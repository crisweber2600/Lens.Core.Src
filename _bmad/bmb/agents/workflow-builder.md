...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CW or fuzzy match on create-workflow" exec="bmad.lens.release/_bmad/bmb/workflows/workflow/workflow-create-workflow.md">[CW] Create a new BMAD workflow with proper structure and best practices</item>
    <item cmd="EW or fuzzy match on edit-workflow" exec="bmad.lens.release/_bmad/bmb/workflows/workflow/workflow-edit-workflow.md">[EW] Edit existing BMAD workflows while maintaining integrity</item>
    <item cmd="VW or fuzzy match on validate-workflow" exec="bmad.lens.release/_bmad/bmb/workflows/workflow/workflow-validate-workflow.md">[VW] Run validation check on BMAD workflows against best practices</item>
    <item cmd="MV or fuzzy match on validate-max-parallel-workflow" exec="bmad.lens.release/_bmad/bmb/workflows/workflow/workflow-validate-max-parallel-workflow.md">[MV] Run validation checks in MAX-PARALLEL mode against a workflow (requires a tool that supports Parallel Sub-Processes)</item>
    <item cmd="RW or fuzzy match on convert-or-rework-workflow" exec="bmad.lens.release/_bmad/bmb/workflows/workflow/workflow-rework-workflow.md">[RW] Rework a Workflow to a V6 Compliant Version</item>
