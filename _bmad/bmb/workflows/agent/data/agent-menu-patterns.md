...
- trigger: CP or fuzzy match on create-prd
  exec: '_bmad/bmm/workflows/create-prd/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '_bmad/bmm/tasks/team-standup.md'
  data: '_bmad/_config/agent-manifest.csv'
...
menu:
  ...
  - trigger: SM or fuzzy match on save-memory
    action: 'Update _bmad/_memory/journal-keeper-sidecar/memories.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '_bmad/bmm/workflows/workflow-status/workflow.md'
...
7. **Sidecar paths:** `_bmad/_memory/{sidecar-folder}/`
