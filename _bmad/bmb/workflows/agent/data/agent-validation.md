...
- [ ] No `bmad.lens.release/_bmad/_memory/` paths
...
- [ ] ALL sidecar paths: `bmad.lens.release/_bmad/_memory/{sidecar-folder}/...`
...
| `./sidecar/memories.md` | `bmad.lens.release/_bmad/_memory/sidecar/memories.md` |
