...
# File References
nextStepFile: '_bmad/bmm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `_bmad/bmm/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
