...
# File References
nextStepFile: '_bmad/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-05-domain.md'
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-05-domain.md`.
