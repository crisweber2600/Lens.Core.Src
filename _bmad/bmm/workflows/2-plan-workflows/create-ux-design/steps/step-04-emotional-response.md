...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with the current emotional response content
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with the current emotional response definition
...
- Load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
