...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with the current inspiration analysis content
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with the current inspiration analysis
...
- Read fully and follow: `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-06-design-system.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-06-design-system.md` to choose the appropriate design system approach.
