...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with the current design system content
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with the current design system choice
...
- Load `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
