...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with the current design direction content
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with the current design direction
...
- Load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md` to design user journey flows.
