...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with the current user journey content
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.
