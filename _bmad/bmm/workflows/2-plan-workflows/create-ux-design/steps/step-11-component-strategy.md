...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with the current component strategy content
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.
