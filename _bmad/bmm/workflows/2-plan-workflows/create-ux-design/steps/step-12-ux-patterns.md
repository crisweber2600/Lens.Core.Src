...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with the current UX patterns content
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
