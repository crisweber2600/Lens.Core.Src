...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with the current responsive/accessibility content
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
...
- Load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.
