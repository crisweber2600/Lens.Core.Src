...
- **STOP here** and load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-01b-continue.md` immediately
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-02-context.md` to analyze the project context and begin architectural decision making.
