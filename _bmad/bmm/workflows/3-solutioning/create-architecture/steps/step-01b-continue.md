...
- Example: If `stepsCompleted: [1, 2, 3]`, load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-01-init.md`
