...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with the current context analysis
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with the current project context
...
- Load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md` to evaluate starter template options.
