...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with current starter analysis
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
