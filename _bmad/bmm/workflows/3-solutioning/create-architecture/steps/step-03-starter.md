...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with current starter analysis
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
