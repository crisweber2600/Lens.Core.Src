...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/advanced-elicitation/workflow.yaml with current patterns
...
- Read fully and follow: bmad.lens.release/_bmad/core/workflows/party-mode/workflow.md with implementation patterns context
...
- Load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
...
After user selects 'C' and content is saved to document, load `bmad.lens.release/_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md` to define the complete project structure.
