...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with current project structure
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with project structure context
...
- Load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
