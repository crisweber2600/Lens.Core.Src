...
- Read fully and follow: _bmad/core/workflows/advanced-elicitation/workflow.yaml with validation issues
...
- Read fully and follow: _bmad/core/workflows/party-mode/workflow.md with validation context
...
- Load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
...
After user selects 'C' and content is saved to document, load `_bmad/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.
