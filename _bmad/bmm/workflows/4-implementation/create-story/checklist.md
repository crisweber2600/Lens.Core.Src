...
- The `bmad.lens.release/_bmad/core/tasks/workflow.xml` framework will automatically:
...
3. **Load validation framework**: `bmad.lens.release/_bmad/core/tasks/workflow.xml`
