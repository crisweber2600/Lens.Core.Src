...
```xml
<invoke-task>Review {diff_output} using bmad.lens.release/_bmad/core/tasks/review-adversarial-general.yaml</invoke-task>
```
...
With findings in hand, read fully and follow: `bmad.lens.release/_bmad/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
