...
- IF C: Verify frontmatter updated with `stepsCompleted: [1, 2]`, then read fully and follow: `_bmad/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-03-generate.md`
