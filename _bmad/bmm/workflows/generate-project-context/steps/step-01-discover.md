...
After user selects [C] to continue, load `bmad.lens.release/_bmad/bmm/workflows/generate-project-context/steps/step-02-generate.md` to collaboratively generate the specific project context rules.
