...
After completing all rule categories and user selects 'C' for the final category, load `bmad.lens.release/_bmad/bmm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.
