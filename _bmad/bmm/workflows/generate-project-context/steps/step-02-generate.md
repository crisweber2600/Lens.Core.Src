...
- When 'A' selected: Execute _bmad/core/workflows/advanced-elicitation/workflow.yaml
- When 'P' selected: Execute _bmad/core/workflows/party-mode
...
After completing all rule categories and user selects 'C' for the final category, load `_bmad/bmm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.
