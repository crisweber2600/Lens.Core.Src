...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BG or fuzzy match on brainstorm-game" exec="{project-root}/_bmad/gds/workflows/1-preproduction/brainstorm-game/workflow.md">[BG] Brainstorm Game ideas and concepts</item>
