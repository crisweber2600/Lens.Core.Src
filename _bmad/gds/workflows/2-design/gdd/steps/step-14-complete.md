...
# Workflow References
narrativeWorkflow: '_bmad/gds/workflows/2-design/narrative/workflow.yaml'
architectureWorkflow: '_bmad/gds/workflows/3-technical/game-architecture/workflow.yaml'
---
