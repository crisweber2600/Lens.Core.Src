...
# Handoff References
epicWorkflow: 'bmad.lens.release/_bmad/gds/workflows/4-production/epic-workflow/workflow.yaml'
projectContextWorkflow: 'bmad.lens.release/_bmad/gds/workflows/3-technical/generate-project-context/workflow.md'
---
