...
# Handoff References
epicWorkflow: '_bmad/gds/workflows/4-production/epic-workflow/workflow.yaml'
projectContextWorkflow: '_bmad/gds/workflows/3-technical/generate-project-context/workflow.md'
---
