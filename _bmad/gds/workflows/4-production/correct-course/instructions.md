...
<critical>You MUST have already loaded and processed: bmad.lens.release/_bmad/gds/workflows/4-production/correct-course/workflow.yaml</critical>
...
<critical>DOCUMENT OUTPUT: Updated epics, stories, or PRD sections. Clear, actionable changes. User skill level ({game_dev_experience}) affects conversation style ONLY, not document updates.</critical>
