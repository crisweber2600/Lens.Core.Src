...
- The `bmad.lens.release/_bmad/core/tasks/validate-workflow.yaml` framework will automatically:
...
- **Validation framework**: `validate-workflow.yaml` (handles checklist execution)
...
3. **Load validation framework**: `bmad.lens.release/_bmad/core/tasks/validate-workflow.yaml`
