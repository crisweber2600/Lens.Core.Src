...
<critical>You MUST have already loaded and processed: bmad.lens.release/_bmad/gds/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="bmad.lens.release/_bmad/gds/workflows/workflow-status">
