...
<critical>You MUST have already loaded and processed: _bmad/gds/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="_bmad/gds/workflows/workflow-status">
