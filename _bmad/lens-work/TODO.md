...
- Fixed `promote-to-release.yml`: version extraction bug, IDE list mismatch, prompt overlay deletion bug, Output Folder sed bug, `.xml` word-boundary fix, PR body wds omission
