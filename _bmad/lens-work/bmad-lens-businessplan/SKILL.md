...
11. **Review-ready check:** Run `python3 {project-root}/_bmad/lens-work/scripts/validate-phase-artifacts.py --phase businessplan --contract review-ready --lifecycle-path {project-root}/_bmad/lens-work/lifecycle.yaml --docs-root {staged_docs_path} --json`
