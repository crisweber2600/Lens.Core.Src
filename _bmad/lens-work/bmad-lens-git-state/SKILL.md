...
```bash
python3 _bmad/lens-work/skills/bmad-lens-git-state/scripts/git-state-ops.py branch-state \
...
```bash
python3 _bmad/lens-work/skills/bmad-lens-git-state/scripts/git-state-ops.py active-features \
...
```bash
python3 _bmad/lens-work/skills/bmad-lens-git-state/scripts/git-state-ops.py discrepancies \
  --repo <control-repo> \
  --governance-repo <governance-repo>
```
...
```bash
python3 _bmad/lens-work/skills/bmad-lens-git-state/scripts/git-state-ops.py feature-state \
  --repo <control-repo> \
  --governance-repo <governance-repo> \
