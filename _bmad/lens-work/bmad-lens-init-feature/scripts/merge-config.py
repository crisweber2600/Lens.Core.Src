...
def parse_args():
    ...
    parser.add_argument(
        "--user-config-path",
        required=True,
        help="Path to the target {project-root}/lens.core/_bmad/config.user.yaml file",
    )
    parser.add_argument(
        "--legacy-dir",
        help="Path to {project-root}/lens.core/_bmad/ directory to check for legacy per-module config files. "
