...
- Report delegation: `[techplan:delegate] routing to bmad-lens-bmad-skill → bmad-create-architecture`
...
- **Governance writes are prohibited** — all governance writes are routed through the publish hook or `bmad-lens-feature-yaml`. Direct file writes to the governance repo are forbidden from this skill.
- **Wrapper delegation** — architecture authoring is always routed through `bmad-lens-bmad-skill`. No inline architecture generation occurs in this skill.
...
8. Publish reviewed businessplan artifacts to governance before architecture authoring begins by running the publish hook:
   ...
   Load `{project-root}/lens.core/_bmad/lens-work/skills/bmad-lens-git-orchestration/SKILL.md` and invoke:
...
9. Load domain constitution for governance context by running:
   ...
   Load `{project-root}/lens.core/_bmad/lens-work/skills/bmad-lens-constitution/SKILL.md` and invoke:
...
10. Verify that the businessplan adversarial review artifact exists with `status: responses-recorded`.
    ...
    Load `{project-root}/lens.core/_bmad/lens-work/skills/bmad-lens-adversarial-review/SKILL.md` and invoke:
...
11. Delegate architecture authoring to the Lens BMAD wrapper.
    ...
    Load `{project-root}/lens.core/_bmad/lens-work/skills/bmad-lens-bmad-skill/SKILL.md` and invoke:
...
13. On review pass, update `feature.yaml` phase to `techplan-complete` via `bmad-lens-feature-yaml`.
...
| `techplan-adversarial-review.md` | `docs/{domain}/{service}/{featureId}/techplan-adversarial-review.md` | `bmad-lens-adversarial-review` |
...
|-------------------|------|
| `bmad-lens-git-orchestration` | Publish reviewed businessplan artifacts to governance |
| `bmad-lens-bmad-skill` | Architecture authoring delegation via BMAD wrapper |
| `bmad-lens-adversarial-review` | Phase completion review gate |
| `bmad-lens-constitution` | Domain constitution loading for context |
| `bmad-lens-feature-yaml` | Reads and updates feature.yaml phase state |
