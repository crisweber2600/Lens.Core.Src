...
```bash
python {project-root}/_bmad/lens-work/bmad-lens-work-setup/scripts/merge-config.py --module-yaml {project-root}/_bmad/lens-work/bmad-lens-work-setup/assets/module.yaml --target-config {project-root}/_bmad/_config/manifest.yaml
```
...
```bash
python {project-root}/_bmad/lens-work/bmad-lens-work-setup/scripts/merge-help-csv.py --module-csv {project-root}/_bmad/lens-work/bmad-lens-work-setup/assets/module-help.csv --target-csv {project-root}/_bmad/_config/bmad-help.csv
```
...
```bash
python {project-root}/_bmad/lens-work/bmad-lens-work-setup/scripts/cleanup-legacy.py --module-dir {project-root}/_bmad/lens-work
```
