...
- **Prompts: published lens-work families** — `.github/prompts/` contains the published `lens-work*.prompt.md` and `lens-*.prompt.md` stub families generated by the installer; preflight enforces this allowlist
