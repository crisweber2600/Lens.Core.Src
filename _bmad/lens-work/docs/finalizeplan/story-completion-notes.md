...
`{project-root}/lens.core/_bmad/lens-work/skills/bmad-lens-git-orchestration/scripts/git-orchestration-ops.py` currently maps `PHASE_ARTIFACTS["expressplan"]` to legacy artifact slugs: `product-brief`, `prd`, `architecture`, `epics`, `stories`, `sprint-status`, and `review-report`.
