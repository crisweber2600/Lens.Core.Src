...
| FinalizePlan step-3 bundle plus final PR path | High | Structural tests verify delegation order and phase-update placement, but do not execute downstream BMAD skills or create a final PR. | Add an end-to-end fixture that mocks `bmad-lens-bmad-skill` outputs and `bmad-lens-git-orchestration create-pr`. |
