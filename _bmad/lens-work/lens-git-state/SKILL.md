...
```bash
uv run --script _bmad/lens-work/lens-git-state/scripts/git-state-ops.py branch-state \
...
```bash
uv run --script _bmad/lens-work/lens-git-state/scripts/git-state-ops.py active-features \
...
```bash
uv run --script _bmad/lens-work/lens-git-state/scripts/git-state-ops.py discrepancies \
  --repo <control-repo> \
  --governance-repo <governance-repo>
```
...
```bash
uv run --script _bmad/lens-work/lens-git-state/scripts/git-state-ops.py feature-state \
  --repo <control-repo> \
  --governance-repo <governance-repo> \
