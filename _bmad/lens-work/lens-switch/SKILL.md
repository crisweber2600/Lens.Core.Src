...
```bash
uv run --with pytest {project-root}/lens.core/_bmad/lens-work/skills/lens-switch/scripts/tests/test-switch-ops.py -q
```
...
| `lens-quickplan` | Uses active feature as the planning target |
