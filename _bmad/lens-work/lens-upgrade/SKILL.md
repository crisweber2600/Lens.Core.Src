...
- bmad-lens-module-management: baseline module version/status checks.
- bmad-lens-migrate: legacy branch/topology migration route.
- bmad-lens-git-state: repository cleanliness checks before upgrade actions.
- bmad-lens-git-orchestration: optional follow-up git-safe operations.
