...
1. Confirm the `.github/prompts/lens-discover.prompt.md` stub already ran `python3 ./lens.core/_bmad/lens-work/scripts/light-preflight.py` successfully from the workspace root.
