...
1. Confirm the `.github/prompts/lens-discover.prompt.md` stub already ran `$PYTHON ./lens.core/_bmad/lens-work/skills/lens-preflight/scripts/light-preflight.py` successfully from the workspace root.
