...
1. Confirm the `.github/prompts/lens-discover.prompt.md` stub already ran `uv run ./lens.core/_bmad/lens-work/scripts/light-preflight.py` successfully from the workspace root.
