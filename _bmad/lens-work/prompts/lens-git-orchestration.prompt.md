---
description: 'Execute Lens git write workflows and promotion operations.'
---
...
```
Read and follow all instructions in: lens.core/_bmad/lens-work/skills/bmad-lens-git-orchestration/SKILL.md
```