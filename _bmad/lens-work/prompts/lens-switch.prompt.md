...
1. Check whether this `/lens-switch` invocation already includes a successful run of `python3 ./lens.core/_bmad/lens-work/scripts/light-preflight.py` from the workspace root.
