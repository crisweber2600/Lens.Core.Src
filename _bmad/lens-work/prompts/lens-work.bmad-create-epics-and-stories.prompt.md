...
description: "Run bmad-create-epics-and-stories with Lens feature, repo, and governance context"
---

# /bmad-create-epics-and-stories Prompt
...
2. Execute `{project-root}/lens.core/_bmad/lens-work/workflows/utility/lens-bmad-skill/workflow.md` with parameters:
   - `skill_id`: `bmad-create-epics-and-stories`
3. The wrapper resolves the active feature scope, governance rules, and planning output path before delegating to the BMAD skill.