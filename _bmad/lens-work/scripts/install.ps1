...
'@
    ...
    $prompts = @(
        ...
        @{ File = 'lens-work.new-feature.prompt.md'; Name = 'lens-work.new-feature'; Desc = 'Create new feature-level initiative within a service'; Target = 'lens-work.new-feature.prompt.md'; Extra = "`nInvoke with scope: **feature**" }
