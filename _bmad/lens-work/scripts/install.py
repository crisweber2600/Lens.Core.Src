...
COMMANDS = [
    ...
    ("bmad-lens-init-milestone.md", "init-milestone", "Create new milestone with 2-branch topology", "skills/bmad-lens-init-feature/SKILL.md"),
...
"""
    ...
    prompts = [
        ...
        ("lens-init-milestone.prompt.md", "lens-init-milestone", "Create a new milestone with 2-branch topology", "lens-init-milestone.prompt.md"),
        ("lens-new-workstream.prompt.md", "lens-new-workstream", "Create new workstream-level constitution scaffolding", "lens-new-workstream.prompt.md"),
        ("lens-new-project.prompt.md", "lens-new-project", "Create new project-level constitution scaffolding within a workstream", "lens-new-project.prompt.md"),
        ("lens-new-milestone.prompt.md", "lens-new-milestone", "Initialize a new milestone with 2-branch topology, milestone YAML, and PR", "lens-new-milestone.prompt.md"),
        ...
        ("lens-milestone-yaml.prompt.md", "lens-milestone-yaml", "Milestone YAML lifecycle operations", "lens-milestone-yaml.prompt.md"),
