...
class TestValidatePhaseArtifactsStoryFiles:
    ...
    def test_finalizeplan_review_ready_tech_change_only_requires_architecture(self, tmp_path):
        docs_root = tmp_path / "feature-docs"
        docs_root.mkdir()
        (docs_root / "architecture.md").write_text("# Architecture\n", encoding="utf-8")
    ...
    def test_finalizeplan_review_ready_tech_change_fails_without_architecture(self, tmp_path):
        docs_root = tmp_path / "feature-docs"
        docs_root.mkdir()
