...
**Goal:** Perform initial brownfield discovery, then hand off to the discovery skill for deep analysis.
...
6. **step-05-handoff-discovery** - **CRITICAL: Present deep scan prompt**

## Important

**DO NOT skip step-05-handoff-discovery.** After initial discovery completes (step-04), you MUST:
