...
`bmad.lens.release/_bmad/tea/workflows/testarch/framework/steps-c/step-01-preflight.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`bmad.lens.release/_bmad/tea/workflows/testarch/framework/steps-c/step-01b-resume.md`
