...
`bmad.lens.release/_bmad/tea/workflows/testarch/nfr-assess/steps-c/step-01-load-context.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`bmad.lens.release/_bmad/tea/workflows/testarch/nfr-assess/steps-c/step-01b-resume.md`
