...
This layer is small but critical: it is what release consumers see first.
...
This is why prompt stubs and skill wrappers in `.github/` must stay aligned with the module manifest, registry, and installer behavior.
...
- [../_bmad/lens-work/docs/architecture.md](../_bmad/lens-work/docs/architecture.md)
- [../_bmad/lens-work/docs/pipeline-source-to-release.md](../_bmad/lens-work/docs/pipeline-source-to-release.md)
- [../_bmad/lens-work/docs/copilot-adapter-reference.md](../_bmad/lens-work/docs/copilot-adapter-reference.md)
- [../_bmad/lens-work/docs/lifecycle-reference.md](../_bmad/lens-work/docs/lifecycle-reference.md)
