...
- **21** embedded markdown reference docs under `_bmad/lens-work/docs/`
...
The module already ships a full embedded doc set under `_bmad/lens-work/docs/`. The docs in this `docs/` folder are the parent-level guide for contributors working on Lens.Core.Src itself.
...
Start with [index.md](./index.md) for the parent-level documentation index. Then continue into the embedded module docs through [../_bmad/lens-work/docs/index.md](../_bmad/lens-work/docs/index.md).
