...
# ///
"""Run read-only Lens topology doctor checks."""
...
from lens_seed_core import run_doctor  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Lens doctor checks.")
    ...
    result = run_doctor(parser.parse_args())
