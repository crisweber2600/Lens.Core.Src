...
# ///
"""Generate deterministic Salmon impact signal and candidate reports."""
...
from lens_seed_core import run_salmon_report  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Lens Salmon impact review.")
    ...
    result = run_salmon_report(parser.parse_args())
